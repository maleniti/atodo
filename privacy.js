...
const PRIVACY_I18N = {
  en: {
    ...
    'privacy.updated': 'Last updated: 18 September 2026',
    'privacy.intro':
    ...
    'privacy.s4':
      "<h2>4. Data retention and automatic deletion</h2><p>You can export a copy of your data or permanently delete your account and all associated data at any time from Settings.</p><p>If you don't log in for 12 consecutive months, your account and every task, note, and setting tied to it are automatically and permanently deleted. There is no way to recover data after this happens -- we recommend downloading a copy of your data before an extended absence if you'd like to keep it. If you have an active paid subscription, you can instead schedule your account for deletion when that subscription ends, rather than losing access to it immediately -- see Settings.</p>",
    'privacy.s5':
      "<h2>5. Data sharing</h2><p>We don't sell or share your personal information with third parties, except:</p><ul><li>Our payment processor (Stripe), solely to process a subscription payment you initiate.</li><li>Where required to comply with a legal obligation.</li></ul>",
    'privacy.s6':
      '<h2>6. Your rights</h2><p>You can, at any time and without contacting us:</p><ul><li>Download a copy of all data associated with your account, from Settings.</li><li>Correct your account information (nickname, email-related settings) from Settings.</li><li>Permanently delete your account and all its data, from Settings.</li></ul><p>If you have any other request regarding your personal data, contact us using the details below.</p>',
    'privacy.s7':
  ...
  hr: {
    ...
    'privacy.updated': 'Zadnje ažurirano: 18. rujna 2026.',
    'privacy.intro':
    ...
    'privacy.s4':
      '<h2>4. Čuvanje podataka i automatsko brisanje</h2><p>Kopiju svojih podataka možete preuzeti, ili trajno izbrisati svoj račun i sve povezane podatke, u bilo kojem trenutku putem Postavki.</p><p>Ako se ne prijavite 12 mjeseci zaredom, vaš račun i svaki zadatak, bilješka i postavka vezana uz njega automatski se i trajno brišu. Nakon toga podatke nije moguće vratiti -- preporučujemo da preuzmete kopiju svojih podataka prije duljeg izbivanja ako ih želite sačuvati. Ako imate aktivnu plaćenu pretplatu, umjesto toga možete zakazati brisanje računa za trenutak isteka te pretplate, kako ne biste odmah izgubili pristup -- pogledajte Postavke.</p>',
    'privacy.s5':
      '<h2>5. Dijeljenje podataka</h2><p>Ne prodajemo niti dijelimo vaše osobne podatke s trećim stranama, osim:</p><ul><li>Našeg obrađivača plaćanja (Stripe), isključivo radi obrade plaćanja pretplate koje sami pokrenete.</li><li>Kada je to potrebno radi usklađenosti sa zakonskom obvezom.</li></ul>',
    'privacy.s6':
      '<h2>6. Vaša prava</h2><p>U bilo kojem trenutku, bez potrebe da nas kontaktirate, možete:</p><ul><li>Preuzeti kopiju svih podataka vezanih uz vaš račun, putem Postavki.</li><li>Ispraviti podatke svog računa (nadimak, postavke vezane uz e-mail) putem Postavki.</li><li>Trajno izbrisati svoj račun i sve njegove podatke, putem Postavki.</li></ul><p>Ako imate bilo kakav drugi zahtjev vezan uz vaše osobne podatke, kontaktirajte nas putem podataka navedenih ispod.</p>',
    'privacy.s7':
